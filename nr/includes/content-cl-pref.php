<!-- Preferences Page -->
        <div class="grid_8">
            <form id="myForm" action="CL-create.php" method="post">
            <div class="box">
                <legend><h2>Create Your Account</h2></legend>
                <div class="grid-4-12">
                <div class="fieldbox">
                    <label for="username" class="inlined">Login</label>
                    <input id="username" type="text" class="form-txt input-text bin" name="Clubber_Name" value="<?php echo $Init_Clubber_Name ?>" />
                    <ul class="vali">
                ...
                <div class="fieldbox">
                    ...
                    <input id="password" type="password" class="form-txt input-text"/>
                    <ul class="vali">
                        <li class="success"><img src="css/img/greencheck.png"/></li>
                        <li class="fail"><img src="css/img/redx.png"/></li>
                    </ul>
                ...
                <div class="fieldbox">
                    ...
                    <input id="conpassword" type="password" class="form-txt input-text"/>
                    <ul class="vali">
                        <li class="success"><img src="css/img/greencheck.png"/></li>
                        <li class="fail"><img src="css/img/redx.png"/></li>
                    </ul>
                ...
                <div class="fieldbox">
                    ...
                    <input id="displayname" name="displayname" type="text" class="form-txt input-text"/>
                    <label for="zip" class="inlined">Zip Code</label>
                    ...
                    <input id="email" type="text" class="form-txt input-text bin"/>
                    <ul class="vali">
                        <li class="success"><img src="css/img/greencheck.png"/></li>
                        <li class="fail"><img src="css/img/redx.png"/></li>
                    </ul>
                ...
                <ul class="form-list-chk" style="width:200px;">
                    <li><label class="form-lbl"><input name="epilepse" type="checkbox"/>Epilepsy</label></li>
                ...
                <div class="field-clear"></div>
                    ...
                    <div class="grid-4-12 atmos">
                        ...
                        <select name="Clubber_Smoking_Preference">
                          ...
                          <option>Must Allow Smoking</option>
                          <option>Must Not Allow Smoking</option>
                        </select>
                        <label>Sexual Preference</label>
                        <select name="Clubber_Gay_Preference">
                          <option>Show All Events</option>
                          <option>Show Only Gay Events</option>
                          <option>Do Not Show Gay Events</option>
                        </select>
                        </div>
                    </div>
                    <div class="grid-4-12 fx">
                        <h2>FX</h2>
...
$("input#conpassword").blur(function(){
    $(this).next("ul").children("li").hide();
    if($(this).val() === ""){
        $(this).css("border","1px red solid");
        $(this).next("ul").children("li.fail").show();
...
/**
 *  Zip Code Validation
 *  Check validity of zip code entered into inpu
